  ...
  return (
    <>
      ...
      <div style={{ marginTop: '2rem' }}>
        ...
        <pre>
          <code>{'const jsElement = ' + JSON.stringify(jsElement, null, 2)}</code>
        </pre>
      </div>
      ...
      <div style={{ marginTop: '2rem' }}>
        ...
        >
          <h3 style={{ color: 'darkblue', margin: 0 }}>Styled with Inline CSS</h3>
      ...
      <div className="App">
        ...
        <PropsDisplayer prop1="first" prop2="second" prop3={3} prop4={{ nested: 'object' }} />
      </div>
    </>
  )
}
