// Index file for useEffect demos - exports all demo components

export { default as BasicClockDemo, BasicClock, UseEffectPatternsDemo } from './BasicClock.jsx';
export { default as ClockWithTickerDemo, ClockWithTicker } from './ClockWithTicker.jsx';
