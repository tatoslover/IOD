/**
 * Enhanced Calculator Application - Main Server File
 *
...
app.get('/api', (req, res) => {
  res.json({
    service: 'Enhanced Calculator API',
    version: '2.0.0',
    ...
    examples: {
      ...
      power: '/calculator/power?num1=2&num2=3',
      squareRoot: '/calculator/sqrt?num=16',
...
const server = app.listen(PORT, () => {
  ...
  console.log(`   • Power: GET http://localhost:${PORT}/calculator/power?num1=2&num2=3`);
  console.log(`   • Square Root: GET http://localhost:${PORT}/calculator/sqrt?num=16`);
