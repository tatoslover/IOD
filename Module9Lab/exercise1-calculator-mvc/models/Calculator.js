...
class Calculator {
   ...
   */
  power(base, exponent) {
    this.#validateInputs(base, exponent);

    const result = this.#roundResult(Math.pow(base, exponent));
  ...
  /**
   * Square root operation (bonus feature)
