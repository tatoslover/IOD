 ...
 * - Advanced Operations: GET /power, /sqrt
...
// Advanced operations (bonus features)
// GET /calculator/power?num1=2&num2=3
router.get('/power',
  validationMiddleware.validateTwoNumbers,
  (req, res) => calculatorController.power(req, res)
);

// GET /calculator/sqrt?num=16
router.get('/sqrt',
  validationMiddleware.validateSingleNumber,
  (req, res) => calculatorController.sqrt(req, res)
);
...
router.get('/', (req, res) => {
  res.json({
    ...
    version: '2.0.0',
    description: 'RESTful calculator API with MVC architecture',
    endpoints: {
      'Basic Operations': {
      ...
      'Advanced Operations': {
        'GET /calculator/power?num1=X&num2=Y': 'Power (X^Y)',
        'GET /calculator/sqrt?num=X': 'Square Root'
      },
      'POST Operations': {
        ...
        'POST /calculator/power': 'Power (body: {num1, num2})',
        'POST /calculator/sqrt': 'Square Root (body: {num})'
      },
      'Management': {
    ...
    examples: {
      ...
      power: 'GET /calculator/power?num1=2&num2=3',
      squareRoot: 'GET /calculator/sqrt?num=16',
